// ================================================================
//  KWON FITNESS – CONFIGURATION V2.0
...
const CONFIG = {
    ...
    // ВАЖНО:
    // Этот пароль всё ещё находится на клиенте.
    // Для production его необходимо перенести на backend.
...
console.log(
    '⚙️ KWON config.js V2.0 загружен'
);