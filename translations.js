...
const LANG = {
    ru: {
        ...
        max_rank: 'Максимальный ранг', // NEW
        ...
        delete_user: 'Удалить пользователя', // NEW
        confirm_delete_user: 'Точно удалить пользователя {nick}? Это действие необратимо.', // NEW
        ...
        change_frame: 'Сменить рамку', // NEW
        change_banner: 'Сменить баннер', // NEW
        change_title: 'Сменить титул', // NEW
        item_picker_title: 'Выберите {type}', // NEW
    ...
    en: {
        ...
        confirm_delete_user: 'Are you sure you want to delete user {nick}? This is irreversible.', // NEW
        ...
        change_frame: 'Change frame', // NEW
        change_banner: 'Change banner', // NEW
        change_title: 'Change title', // NEW
        item_picker_title: 'Choose {type}', // NEW
