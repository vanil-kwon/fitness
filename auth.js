// ================================================================
//  KWON FITNESS – АВТОРИЗАЦИЯ И РЕГИСТРАЦИЯ (UPDATED)
//  Добавлено поле email, SHA-256, async/await
// ================================================================
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (registerSubmitBtn) {
        registerSubmitBtn.addEventListener('click', async function() {
            ...
            const email = document.getElementById('regEmail').value.trim(); // NEW
