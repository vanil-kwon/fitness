...
//  Добавлено сохранение через saveCurrentUser
// ================================================================

// ... в loginBtn после успешного входа можно вызвать saveCurrentUser, но showMainScreen это делает
// в registerSubmitBtn после создания нового пользователя используем saveUsers напрямую, но можно сохранить
// (оставляем как есть)
